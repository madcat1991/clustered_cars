...
def get_idf(bdf):
    ...
    item_cols = [
        u'propcode', u'year', u'region', u'stars',
        u'sleeps', u'shortbreakok', u'bathrooms'
    ]
    idf = idf[item_cols]
    idf.stars = prepare_num_column(idf.stars)
    idf.sleeps = prepare_num_column(idf.sleeps, min_bin_p=0.02)
    idf.bathrooms = prepare_num_column(idf.bathrooms)
    idf.shortbreakok += 1
    return idf
